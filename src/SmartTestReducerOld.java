...
public class SmartTestReducerOld extends TestReducer
{
	private int[][] families;
	private long smartTestReduceTimeout;

	public SmartTestReducerOld(SUTInterface sut, int[] actTraceArray, Tester tester2) 
	{
		super(sut, actTraceArray, tester2);
	}

	public SmartTestReducerOld(SUTInterface sut, ArrayList<Integer> actTrace, Tester tester) 
	{
